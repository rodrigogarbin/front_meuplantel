            ...
            <nav className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 px-4 py-2 pb-[calc(0.5rem+env(safe-area-inset-bottom))] z-50">
                <div className="flex justify-around max-w-md mx-auto">
                    ...
                    <button
                        ...
                        className={`flex flex-col items-center py-2 px-4 transition-colors relative ${isActive('/config') ? 'text-blue-500' : 'text-gray-500 dark:text-gray-400'
                            }`}
                    >
                        {hasConfigBadge && (
                            <span className="absolute top-1 right-2 w-2.5 h-2.5 bg-red-500 rounded-full border-2 border-white dark:border-gray-800" />
                        )}
