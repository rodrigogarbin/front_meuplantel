...
function CasalHistoricoCard({ casal, onClick }: CasalHistoricoCardProps) {
    ...
    return (
        <button
            onClick={onClick}
            className="w-full flex items-start gap-3 p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-750 active:scale-[0.98] transition-all text-left shadow-sm"
        >
            {/* Badge número */}
